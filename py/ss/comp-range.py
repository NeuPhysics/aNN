...
np.savetxt('vout-range-x.txt', vout.x, delimiter=',')
np.savetxt('vout-range-success.txt',np.asarray([vout.success]))
np.savetxt('vout-range-funvalue.txt', np.array([vout.fun]), delimiter=',')
