...
vout=minimize(yp,partot,method='Nelder-Mead',tol=1e-11,options={"ftol":1e-9, "maxfev": 10000000000,"maxiter":100000000000})
#vout=differential_evolution(yp,bounds,strategy='best1bin',tol=0.1,maxiter=1,polish=True)
print vout


np.savetxt('vout-range-d-x.txt', vout.x, delimiter=',')


np.savetxt('vout-range-d-funvalue.txt', np.array([vout.fun]), delimiter=',')
